...
namespace TourGuideTest
{
    public class PerformanceTest : IClassFixture<DependencyFixture>
    {
        ...
        public void HighVolumeTrackLocation()
        {
            ...
            Parallel.ForEach(allUsers, new ParallelOptions { MaxDegreeOfParallelism = 1000 },
                user => _fixture.TourGuideService.TrackUserLocation(user));
        ...
        public void HighVolumeGetRewards()
        {
            ...
            Parallel.ForEach(allUsers,
                user => user.AddToVisitedLocations(new VisitedLocation(user.UserId, attraction, DateTime.Now)));
            
            Parallel.ForEach(allUsers, new ParallelOptions { MaxDegreeOfParallelism = 1000 },
                user => _fixture.RewardsService.CalculateRewards(user));
